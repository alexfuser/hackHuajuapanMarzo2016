    ...
    ULTRA_SETTINGS.uiCalendar = function() {
        ...
        if ($.isFunction($.fn.fullCalendar)) {
            ...
            $('#calendar').fullCalendar({
                ...
                events: [{
                    title: 'Liverpool a las 4 de la tarde',
                    start: new Date(y, m, 1)
                }, {
                    title: 'Proyecto Teoría de la computación 12:30 de mañana',
                    start: new Date(y, m, d 2),
            
                }, {
                    title: 'Apartir de la 1:30 de la tarde la profesora va arecibir los trabajos de cada mes',
                    start: new Date(y, m, d, 10, 30),
                    allDay: false
                }, {
                    title: 'La cita con el doctor es el domingo',
                    start: new Date(y, m, d, 12, 0),
                    end: new Date(y, m, d, 14, 0),
                    allDay: false
                }, {
                    title: 'El domingo a las 11 de la noche es el partido del manchester united',
                    start: new Date(y, m, d + 1, 19, 0),
                    end: new Date(y, m, d + 1, 22, 30),
                    allDay: false
                }, {
                    title: 'Para los compañeros de psicologia, entregar a mas tardar el 14 de este mes el CD con la presentacion',
                    start: new Date(y, m, d + 3, 12, 0),
                    end: new Date(y, m, d + 2, 19, 20),
                    allDay: false
                }, ]
            });
